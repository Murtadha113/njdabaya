            ...
            <Link href={`/categories/${cat.slug}`} className="group block h-full">
              <div
                className={cn(
                  ...
                  i === 0 ? "aspect-square md:aspect-auto" : "aspect-[4/5]"
                )}
              >
                <Image
                ...
                <div className={cn("absolute inset-x-0 bottom-4 text-center text-white", i === 0 && "bottom-6")}>
                  <span className={cn("font-heading", i === 0 ? "text-2xl md:text-3xl" : "text-sm font-medium")}>
                    {cat.name}
                  </span>
                  {i === 0 && (
